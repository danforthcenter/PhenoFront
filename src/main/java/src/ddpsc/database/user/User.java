...
public class User
{
	 ...
	 * @param Group	group 		Group object which this user belongs to.
	 * 
	 * @see {@link Group }
	 */
	public User(String username, String password, boolean enabled, String authority, Group group)
	{
		this.allowedExperiments = new HashSet<Experiment>();
	...
	{
		return authority != null && authority.equals(ADMIN_AUTHORITY);
	}
	...
	{
		boolean validAuthority = authority != null && (authority.equals(USER_AUTHORITY) || authority.equals(ADMIN_AUTHORITY));
